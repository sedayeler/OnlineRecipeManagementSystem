...
import org.example.entities.concretes.BlackSeaRegionRecipe;
...
public class BlackSeaRegionFactory extends RecipeFactory {
    ...
    public Recipe createRecipe(String name, String description, String servingSize, HashSet<Category> categories, HashSet<Tag> tags, String ingredients, String instructions) {
        ...
        recipe = new BlackSeaRegionRecipe(name, description, servingSize, categories, tags, ingredients, instructions);
        return recipe;
    }
