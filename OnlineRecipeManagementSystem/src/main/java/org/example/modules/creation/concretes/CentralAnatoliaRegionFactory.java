...
import org.example.entities.concretes.CentralAnatoliaRegionRecipe;
import org.example.entities.concretes.Tag;
import org.example.modules.creation.abstracts.RecipeFactory;

import java.util.HashSet;

public class CentralAnatoliaRegionFactory extends RecipeFactory {
    ...
    public Recipe createRecipe(String name, String description, String servingSize, HashSet<Category> categories, HashSet<Tag> tags, String ingredients, String instructions) {
        ...
        recipe = new CentralAnatoliaRegionRecipe(name, description, servingSize, categories, tags, ingredients, instructions);
        return recipe;
    }

    @Override
    public String getRegionName() {
        return "Central Anatolia Region";
    }
}
